...
GO
:setvar CurrentDatabaseName "PriceDB"
:setvar ProductDBName "OnPremiseProductDatabase"
:setvar ProductDBSynonymName "ProductDB"
:setvar ProductDB_ProductListTbl "ProductDB_ProductListTbl"
...
GO
PRINT N'Creating [dbo].[ProductDB_ProductListTbl]...';


GO
CREATE SYNONYM [dbo].[ProductDB_ProductListTbl] FOR [LAPTOP-SO8773KH].[$(ProductDBName)].[dbo].[ProductList];
...
SELECT          
                ...
                dbo.ProductDB_ProductListTbl.ProductId as ProductId, 
                dbo.ProductDB_ProductListTbl.ProductName as ProductName,
                p.Price
FROM            dbo.ProductPrice AS p INNER JOIN
                         dbo.ProductDB_ProductListTbl ON p.ProductPriceId = dbo.ProductDB_ProductListTbl.ProductPriceId
