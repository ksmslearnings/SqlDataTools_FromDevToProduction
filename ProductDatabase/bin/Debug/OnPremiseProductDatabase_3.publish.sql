...
GO
:setvar AreDatafixScriptsRunAllowed "True"
:setvar CurrentDatabaseName "OnPremiseProductDatabase"
:setvar PriceDatabase "PriceDatabase"
:setvar PriceDB_ProductPriceTbl_SynonymName "ProductDB"
...
GO
PRINT N'Creating [dbo].[PriceTableSynonym]...';


GO
CREATE SYNONYM [dbo].[PriceTableSynonym] FOR [LAPTOP-SO8773KH].[$(PriceDatabase)].[dbo].[ProductPrice];
